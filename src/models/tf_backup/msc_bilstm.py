...
# 定义 MSC-BiLSTM 模型
def build_msc_bilstm_model(input_shape):
    ...
    # BiLSTM 层
    bilstm_output = Bidirectional(LSTM(32, return_sequences=True))(merged)
...
for noise_type in noise_types:
    ...
    # 构建模型
    model = build_msc_bilstm_model(input_shape=x_train.shape[1:])
    model_name = f"MSC_BiLSTM_{noise_type}"
